...
# from PharmacyApp import serializers

# from PharmacyApp.models import Company, CompanyBank
# from PharmacyApp.serializers import CompanyBankSerializer, CompanySerializer
...
#         response_dict={"error":False, "message":"All Copany List Data", "data":serializer.data}
...
#         response_dict={"error":False, "message":"All Copany Bank List Data", "data":serializer.data}
#         return Response(response_dict)
...
from PharmacyApp.models import Company, CompanyBank, Medicine, MedicalDetails, CompanyAccount, Employee, \
    EmployeeBank, EmployeeSalary, CustomerRequest, Bill, BillDetails
from PharmacyApp.serializers import CompanySerializer, CompanyBankSerializer, MedicineSerliazer, \
